...
public class Linker {
  ...
  public final LinkerDef getLinker(final AbstractCompileMojo mojo, final CCTask task, final String os,
      final List<String> linkPaths) throws MojoExecutionException {
    ...
    if ((this.narDependencyLibOrder == null)) {
         ...
         if (os.equals(OS.AIX)){
            ...
            List<String> dependencyList = Arrays.asList(dependencies.split("SimpleString"));
  ...
  public final String getVersion() throws MojoFailureException {
	  
    return getVersion(new NarCompileMojo());
    
  }

  public final String getVersion(final AbstractNarMojo mojo) throws MojoFailureException {
