...
public class NarManager {
  ...
  public NarManager(final Log log, 
  ...
  public final void downloadAttachedNars(final List<NarArtifact> narArtifacts,
    ...
    for (final Artifact dependency1 : dependencies) {
    	
      final Artifact dependency = dependency1;
  ...
  public final List<AttachedNarArtifact> getAttachedNarDependencies(final List<?> narArtifacts,
      final AOL archOsLinker) throws MojoExecutionException {
	 
	int randomNumber = this.r.nextInt(5);
  ...
  public final List<AttachedNarArtifact> getAttachedNarDependencies(final List/*
    ...
    return getAttachedNarDependencies((Artifact) narArtifacts, aol, type);
  ...
  public final List<AttachedNarArtifact> getAttachedNarDependencies(final List/*
                                                                                    ...
                                                                                    * >
                                                                                    */<?> narArtifacts,
    final String[] classifiers) throws MojoExecutionException {
  ...
  public final File getNarFile(final Artifact dependency) {
