...
public class Javah {
  ...
  //inizio del metodo: Javah
  //mancanza di argomenti in input
  public Javah() {
	  
	  //implementazione mancante
	  //implementazione necessaria per il raggiungimento dello scopo del metodo: Javah
	  
  }
  //fine del metodo: Javah
  //esecuzione metodo: Javah riuscita, ma fuorviante
    ...
    try {
      ...
      if (!classes.isEmpty()) {
        ...
        if (!files.isEmpty()) {
          ...
          final int result = NarUtil.runCommand(javah, generateArgs(files), null, null);
  ...
  private String getJavah() throws MojoExecutionException {
