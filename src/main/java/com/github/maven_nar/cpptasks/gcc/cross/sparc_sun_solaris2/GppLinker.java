...
public class GppLinker extends AbstractLdLinker {
  ...
  private static final GppLinker dllLinker = new GppLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "lib", false, new GppLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "lib", true,
          null));
  
  private static final GppLinker instance = new GppLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "",
      false, null);
  
  private static final GppLinker machDllLinker = new GppLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "lib", false, null);
