...
public class GccLinker extends AbstractLdLinker {
  ...
  private static final GccLinker soLinker = new GccLinker("gcc", objFiles, "lib", false,
      new GccLinker("gcc", objFiles, "lib", true, null));
  
  private static final GccLinker instance = new GccLinker("gcc", objFiles, "", false, null);
  
  private static final GccLinker clangInstance = new GccLinker("clang", objFiles, "", false, null);
  
  
  private static final GccLinker machJNILinker = new GccLinker("gcc", objFiles, "lib", false,
      null);
  
  // FREEHEP added dllLinker for windows
  private static final GccLinker dllLinker = new GccLinker("gcc", objFiles, "", false, null);
  
  private static final String LIB_W32API = "/lib/w32api";
