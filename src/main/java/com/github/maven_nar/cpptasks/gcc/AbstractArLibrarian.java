...
public abstract class AbstractArLibrarian extends CommandLineLinker {
  ...
  protected AbstractArLibrarian(final String command, 
		  						final String identificationArg, 
		  						final String[] inputExtensions,
		  						final String outputExtension,
		  						final boolean isLibtool, 
		  						final AbstractArLibrarian libtoolLibrarian) {
	  
    super(command, identificationArg, inputExtensions, outputExtension, isLibtool, libtoolLibrarian);
