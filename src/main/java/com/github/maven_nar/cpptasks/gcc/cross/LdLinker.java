...
public final class LdLinker extends AbstractLdLinker {
  ...
  private static final LdLinker dllLinker = new LdLinker("ld", objFiles, "lib", false,
      new LdLinker("ld", objFiles, "lib", true, null));
  
  private static final LdLinker instance = new LdLinker("ld", objFiles, "", false, null);
  ...
  LdLinker ldLinkerMethod() throws CloneNotSupportedException {
