...
public class GccLinker extends AbstractLdLinker {
  ...
  private static final GccLinker dllLinker = new GccLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "lib", false, new GccLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "lib", true,
          null));
  
  private static final GccLinker instance = new GccLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "",
      false, null);
  
  private static final GccLinker machBundleLinker = new GccLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles,
      "lib", false, null);
  
  private static final GccLinker machDllLinker = new GccLinker(GccCCompiler.CMD_PREFIX + "gcc", objFiles, "lib", false, null);
