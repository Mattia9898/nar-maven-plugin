...
public class GccLinker extends AbstractLdLinker {
  ...
  private static final GccLinker dllLinker = new GccLinker("gcc", objFiles, "lib", false,
      new GccLinker("gcc", objFiles, "lib", true, null));
  
   /*On AIX shared libaries use .a for extension */
  private static final GccLinker aLinker = new GccLinker("gcc",objFiles, "lib", false, null);
	  
  private static final GccLinker instance = new GccLinker("gcc", objFiles, "", false, null);
  ...
  private static final GccLinker machBundleLinker = new GccLinker("gcc", objFiles, "lib", false, null);
  
  private static final GccLinker machDllLinker = new GccLinker("gcc", objFiles, "lib", false,
      null);
  
  private static final String LIB_W32_API = "/lib/w32api";
  ...
  protected GccLinker(final String command, final String[] extensions,
      final String outputPrefix, final boolean isLibtool, final GccLinker libtoolLinker) {
  ...
  GccLinker gccLinkerMethod() throws CloneNotSupportedException {
