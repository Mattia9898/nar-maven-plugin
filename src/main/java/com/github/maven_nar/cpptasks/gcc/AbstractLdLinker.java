...
public abstract class AbstractLdLinker extends CommandLineLinker {
  ...
  protected AbstractLdLinker(final String command, 
    ...
    super(command, identifierArg, extensions, outputSuffix, isLibtool, libtoolLinker);
  ...
  protected String[] addLibrarySets(final ArrayList<String> endargs) {
    ...
    return new String[libnames.size()];
  ...
  public String[] prepareArguments(final CCTask task, final String outputDir, final String outputFile,
    ...
    if (libnames == null || libnames.length == 0) {
      ...
      return super.prepareArguments(task, outputDir, sourceFiles, config);
    ...
    return super.prepareArguments(task, outputDir, finalSources, config);
