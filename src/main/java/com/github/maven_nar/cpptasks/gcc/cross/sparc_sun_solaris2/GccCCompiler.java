...
public final class GccCCompiler extends GccCompatibleCCompiler {
  ...
  private static final GccCCompiler cppInstance = new GccCCompiler(CMD_PREFIX + "c++", false, new GccCCompiler(CMD_PREFIX + "c++", true, null,
          null), null);
  
  private static final GccCCompiler g77Instance = new GccCCompiler(CMD_PREFIX + "g77", false, new GccCCompiler(CMD_PREFIX + "g77", true, null,
          null), null);
  
  private static final GccCCompiler gppInstance = new GccCCompiler(CMD_PREFIX + "g++", false, new GccCCompiler(CMD_PREFIX + "g++", true, null,
          null), null);
  
  private static final GccCCompiler instance = new GccCCompiler(CMD_PREFIX + "gcc", false, 
		  new GccCCompiler(CMD_PREFIX + "gcc", true, null, null), null);
  ...
  public String getIdentifier() throws BuildException {
	...
	protected String getOutputSuffix() {
		...
		return getBaseOutputName(CMD_PREFIX);
