...
public class GppLinker extends AbstractLdLinker {
  ...
  private static final GppLinker dllLinker = new GppLinker("gcc", objFiles, "lib", false,
      new GppLinker("gcc", objFiles, "lib", true, null));
  ...
  private static final GppLinker instance = new GppLinker("gcc", objFiles, "", false, null);
  
  private static final GppLinker machDllLinker = new GppLinker("gcc", objFiles, "lib", false,
      null);
  
  private static final GppLinker machPluginLinker = new GppLinker("gcc", objFiles, "lib", 
		  false, null);
  ...
  GppLinker gppLinkerMethod() throws CloneNotSupportedException {
