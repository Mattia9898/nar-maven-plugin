...
public abstract class GccCompatibleCCompiler extends CommandLineCCompiler {
   ...
   */
  protected GccCompatibleCCompiler(final String command, 
		  						final boolean libtool,
		  						final GccCompatibleCCompiler libtoolCompiler, 
  ...
  public void addImpliedArgs(final List<String> args, 
		  						final boolean debug,
  ...
  public void addImpliedArgs1(List<String> args, boolean debug, boolean multithreaded, boolean exceptions,
