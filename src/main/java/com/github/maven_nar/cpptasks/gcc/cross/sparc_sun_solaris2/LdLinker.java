...
public final class LdLinker extends AbstractLdLinker {
  ...
  private static final LdLinker dllLinker = new LdLinker(GccCCompiler.CMD_PREFIX + "ld", objFiles, "lib",
      false, new LdLinker(GccCCompiler.CMD_PREFIX + "ld", objFiles, "lib", true, null));
  
  private static final LdLinker instance = new LdLinker(GccCCompiler.CMD_PREFIX + "ld", objFiles, "", false, null);
  ...
  private LdLinker(final String command, final String[] extensions,
      final String outputPrefix, final boolean isLibtool, final LdLinker libtoolLinker) {
	  
    super(command, "-version", extensions, outputPrefix, isLibtool, libtoolLinker);
