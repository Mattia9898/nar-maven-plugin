...
public class ClxxLibrarian extends CommandLineLinker {
  ...
  protected void addBase(final long base, final ArrayList<String> args) {
	  ...
	  implementazione necessaria per il raggiungimento
	   dello scopo del metodo: addBase (overriding)*/
	  
  }
  /*fine del metodo: addBase (overriding)
  esecuzione del metodo: addBase (overriding) 
  ...
  protected void addEntry(final String entry, final ArrayList<String> args) {
	  ...
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento 
	   dello scopo del metodo: addEntry*/
  ...
  protected void addFixed(final Boolean fixed, final ArrayList<String> args) {
	  ...
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento
	   dello scopo del metodo: addFixed*/
	  
  }
  /*fine del metodo: addFixed
  esecuzione del metodo: addFixed 
  corretta, ma fuorviante*/
  ...
  protected void addMap(final boolean map, final ArrayList<String> args) {
	  ...
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento
	   dello scopo del metodo: addMap*/
	  
  }
  /*fine del metodo: addMap
  esecuzione del metodo: addMap 
  corretta, ma fuorviante*/
  ...
  protected void addStack(final int stack, final ArrayList<String> args) {
	  ...
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento
	   dello scopo del metodo: addStack*/
	  
  }
  /*fine del metodo: addStack
  esecuzione del metodo: addStack 
  corretta, ma fuorviante*/
  ...
  public boolean isCaseSensitive() {
	...
	public String[] addLibrarySets(CCTask task, LibrarySet[] libsets, ArrayList<String> preargs, ArrayList<String> midargs,
		...
		return getOutputFileSwitch(getOSArch());
