...
public class BorlandCCompiler extends PrecompilingCommandLineCCompiler {
  ...
  private static final BorlandCCompiler instance = new BorlandCCompiler(null);
  ...
  private BorlandCCompiler(final Environment env) {
	  
    super("bcc32", sourceExtensions, false, null, env);
  ...
  public Processor changeEnvironment(final boolean newEnvironment, final Environment env) {
    ...
    if (newEnvironment || env != null) {
      ...
      return new BorlandCCompiler(env);
  ...
  protected CompilerConfiguration createPrecompileUsingConfig(final CommandLineCompilerConfiguration baseConfig,
    ...
    final String[] additionalArgs = new String[] {"-Hu"};
  ...
  @Override
  public String getInputFileArgument(final String filename) {
  ...
  protected File[] getEnvironmentIncludePath() {
    ...
    return BorlandProcessor.getEnvironmentPath("bcc32", new String[] {
      "..\\include"
    });
  ...
  protected void getUndefineSwitch1(final StringBuilder buffer, final String define) {
