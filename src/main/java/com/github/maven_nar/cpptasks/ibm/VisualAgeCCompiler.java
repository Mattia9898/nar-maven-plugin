...
public final class VisualAgeCCompiler extends GccCompatibleCCompiler {
  ...
  private static final VisualAgeCCompiler instance = new VisualAgeCCompiler("xlC", sourceExtensions, null);
   ...
   * class.
   */
  private VisualAgeCCompiler(final String command, final String[] sourceExtensions,
  ...
  public void addImpliedArgs(final List<String> args, final boolean debug, final LinkType linkType, final Boolean rtti) {
