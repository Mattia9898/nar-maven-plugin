...
public final class VisualAgeLinker extends AbstractLdLinker {
  ...
  private static final VisualAgeLinker dllLinker = new VisualAgeLinker("xlC", objFiles, "lib");
  ...
  private VisualAgeLinker(final String command, final String[] extensions,
  ...
  @Override
  public void
      addImpliedArgs(final boolean debug, final LinkType linkType, final ArrayList<String> args) {
