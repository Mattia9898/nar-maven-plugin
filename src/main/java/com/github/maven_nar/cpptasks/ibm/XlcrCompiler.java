 ...
 * @author Curt Arnold
 */
public final class XlcrCompiler extends CommandLineCCompiler {
  ...
  private static final XlcrCompiler instance = new XlcrCompiler("xlC_r", sourceExtensions, null);
   ...
   */
  public static XlcrCompiler getInstance() {
   ...
   * class.
   */
  private XlcrCompiler(final String command, final String[] sourceExtensions,
  ...
  public void addImpliedArgs1(final List<String> args, final boolean debug,
