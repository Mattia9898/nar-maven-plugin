...
public class LinkerDef extends ProcessorDef {
  ...
  private static final String LINKER_DEF = "LinkerDef";
  ...
  private final ArrayList<LibrarySet> librarySets = new ArrayList<>();
  
  private Boolean map;
  
  private int stack;
  
  private final ArrayList<LibrarySet> sysLibrarySets = new ArrayList<>();
  ...
  public LibrarySet[] getActiveLibrarySets(final LinkerDef[] defaultProviders, final int index) {
    ...
    if (isReference()) {
      ...
      return getCheckedRef(LinkerDef.class, LINKER_DEF)
          .getActiveUserLibrarySets(defaultProviders, index);
      
    }
    
    final ArrayList<LibrarySet> libsets = new ArrayList<>();
    
    return new LibrarySet[libsets.size()];
  ...
  public long getBase(final LinkerDef[] defaultProviders, final int index) {
    ...
    if (isReference()) {
      ...
      return getCheckedRef(LinkerDef.class, LINKER_DEF).getBase(defaultProviders, index);
  ...
  public String getEntry(final LinkerDef[] defaultProviders, final int index) {
    ...
    if (isReference()) {
      ...
      return getCheckedRef(LinkerDef.class, LINKER_DEF).getEntry(defaultProviders, index);
  ...
  public Boolean getFixed(final LinkerDef[] defaultProviders, final int index) {
    ...
    if (isReference()) {
      ...
      return getCheckedRef(LinkerDef.class, LINKER_DEF).getFixed(defaultProviders, index);
  ...
  public boolean getIncremental(final LinkerDef[] defaultProviders, final int index) {
    ...
    if (isReference()) {
      ...
      return getCheckedRef(LinkerDef.class, LINKER_DEF).getIncremental(defaultProviders, index);
  ...
  public boolean getMap(final LinkerDef[] defaultProviders, final int index) {
    ...
    if (isReference()) {
      ...
      return getCheckedRef(LinkerDef.class, LINKER_DEF).getMap(defaultProviders, index);
  ...
  public int getStack(final LinkerDef[] defaultProviders, final int index) {
    ...
    if (isReference()) {
      ...
      return getCheckedRef(LinkerDef.class, LINKER_DEF).getStack(defaultProviders, index);
  ...
  public void visitSystemLibraries(final Linker linker, final FileVisitor libraryVisitor) {
    ...
    if (isReference()) {
      ...
      final LinkerDef master = getCheckedRef(LinkerDef.class, "Linker");
