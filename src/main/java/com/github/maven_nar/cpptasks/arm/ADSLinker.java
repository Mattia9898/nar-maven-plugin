...
public class ADSLinker extends CommandLineLinker {
  ...
  protected void addBase(final long base, final ArrayList<String> args) {
		...
		implementazione necessaria per il raggiungimento
		 dello scopo del metodo: addBase*/
	  
  }
  /*fine del metodo: addBase
  esecuzione del metodo: addBase 
  ...
  esecuzione del metodo: addEntry 
  corretta, ma fuorviante*/
  ...
  protected void addImpliedArgs(final boolean debug, final ArrayList<String> args) {
