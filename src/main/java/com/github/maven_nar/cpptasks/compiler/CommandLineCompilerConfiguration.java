...
public final class CommandLineCompilerConfiguration implements CompilerConfiguration {
  ...
  public CommandLineCompilerConfiguration(final String identifier,
		  									final File[] envIncludePath,
		  									final String includePathIdentifier, 
		  									final String[] args, 
		  									final ProcessorParam[] params, 
  ...
  public CommandLineCompilerConfiguration(final CommandLineCompilerConfiguration base, 
		  									final String[] additionalArgs,
		  									final String[] exceptFiles, 
		  									final boolean isPrecompileHeaderGeneration) {
  ...
  public CompilerConfiguration[]
    ...
    return createPrecompileConfigurations(prototype, nonPrecompiledFiles);
  ...
  public DependencyInfo parseIncludes(final CCTask task, final File baseDir, final File source) {
    ...
    return this.compiler.parseIncludes(getIncludePathIdentifier());
