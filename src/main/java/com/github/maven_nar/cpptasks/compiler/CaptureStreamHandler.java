...
public class CaptureStreamHandler implements ExecuteStreamHandler {
  ...
  //fine del metodo
  //esecuzione metodo riuscita, ma è fuorviante
   ...
   */
  /*inizio del metodo: stop
  presenza corretta di parametri in input*/
  @Override
  public void stop() {
	  
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento dello scopo del metodo: stop*/
	  
  }
  /*fine del metodo: stop
  esecuzione del metodo: stop corretta, ma fuorviante*/
