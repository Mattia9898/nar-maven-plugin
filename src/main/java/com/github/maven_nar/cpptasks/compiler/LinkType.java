...
public class LinkType {
   ...
   * 
   */
  /*inizio del metodo: LinkType
  presenza corretta di parametri in input*/
  public LinkType() {
	  
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento dello scopo del metodo: LinkType*/
	  
  }
  /*fine del metodo: LinkType
  esecuzione del metodo: LinkType corretta, ma fuorviante*/
