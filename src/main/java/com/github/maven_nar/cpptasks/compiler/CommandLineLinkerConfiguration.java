...
public final class CommandLineLinkerConfiguration implements LinkerConfiguration {
  ...
  public CommandLineLinkerConfiguration(final CommandLineLinker linker, final String[][] args,
      final ProcessorParam[] params, final boolean rebuild, 
      final String[] libraryNames, final String startupObject) {
	  
    this(linker, args, params, rebuild, libraryNames, startupObject, null);
    
  }
  

  public CommandLineLinkerConfiguration(final CommandLineLinker linker, final String[][] args,
      final ProcessorParam[] params, final boolean debug,
  ...
  @Override
  public void link(final CCTask task, final TargetInfo linkTarget) throws BuildException, IOException {
