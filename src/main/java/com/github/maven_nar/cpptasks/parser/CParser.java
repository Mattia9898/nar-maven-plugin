...
public final class CParser extends AbstractParser implements Parser {
  ...
  public CParser() {
    ...
    // switch between
    //
    final AbstractParserState nm = new BranchState(this, new char[] {
        'n', 'm'
    }, new AbstractParserState[] {
        n, m
    }, null);
    
    final AbstractParserState i = new WhitespaceOrLetterState(this, 'i', nm);
  ...
  protected void addFilename(String filename) {
	  ...
	  implementazione necessaria per il raggiungimento
	   dello scopo del metodo: addFilename*/
	  
  }
  /*fine del metodo: addFilename
  esecuzione del metodo: addFilename 
