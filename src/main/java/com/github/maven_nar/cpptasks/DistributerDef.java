...
public final class DistributerDef extends DataType {
  ...
  private static final String DISTRIBUTER_DEF = "DistributerDef";
   ...
   */
  private final ArrayList<DistributerMap> maps = new ArrayList<>();
   ...
   *
   */
	/*inizio del metodo: DistributerDef
	presenza corretta di parametri in input*/
  public DistributerDef() {
	  
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento dello scopo del metodo: DistributerDef*/
	  
  }
  /*fine del metodo: DistributerDef
  esecuzione del metodo: DistributerDef corretta, ma fuorviante*/
  ...
  public String getHosts() {
    ...
    if (isReference()) {
      ...
      final DistributerDef refDistributer = getCheckedRef(DistributerDef.class, DISTRIBUTER_DEF);
