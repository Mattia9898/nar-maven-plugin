...
public final class ForteCCLinker extends AbstractLdLinker {
  ...
  private static final ForteCCLinker arLinker = new ForteCCLinker("CC", objFiles, "lib");
  
  private static final ForteCCLinker dllLinker = new ForteCCLinker("CC", objFiles, "lib");
  
  private static final ForteCCLinker instance = new ForteCCLinker("CC", objFiles, "");
  ...
  private ForteCCLinker(final String command, final String[] extensions,
      final String outputPrefix) {
	  
    super(command, "-V", extensions, outputPrefix, false, null);
