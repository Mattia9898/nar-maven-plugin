...
public class C89Processor {
  ...
  static final boolean TYPE_BOOLEAN = true;
  ...
  public static void getDefineSwitch(final StringBuilder buf, final String define, final String value) {
  ...
  public static String[] getLibraryPatterns(final String[] libnames, final LibraryTypeEnum libType) {
    ...
    if (libType == null || "static".equals(libType.getValue())) {
      ...
      addLibraryPatterns(libnames, buf, "lib", ".a", patterns, 0);
  ...
  public static String[] getOutputFileSwitch(final String outPath) {
    ...
    final StringBuilder buf = new StringBuilder("-o ");
  ...
  public static void getUndefineSwitch(final StringBuilder buf, final String define) {
