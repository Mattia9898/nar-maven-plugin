...
public final class TargetDef extends DataType {
  ...
  private static final String TARGET_DEF = "TargetDef";
   ...
   *
   */
  /*inizio del metodo: TargetDef
  presenza corretta di parametri in input*/
  public TargetDef() {
	  
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento dello scopo del metodo: TargetDef*/
	  
  }
  /*fine del metodo: TargetDef
  esecuzione del metodo: TargetDef corretta, ma fuorviante*/
  ...
  public ArchEnum getArch() {
    ...
    if (isReference()) {
      ...
      final TargetDef refPlatform = getCheckedRef(TargetDef.class, TARGET_DEF);
