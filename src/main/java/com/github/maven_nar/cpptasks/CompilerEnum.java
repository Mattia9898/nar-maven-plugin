...
import com.github.maven_nar.cpptasks.ibm.XlcrCompiler;
...
public class CompilerEnum extends EnumeratedAttribute {
  ...
  private static final ProcessorEnumValue[] compilers = new ProcessorEnumValue[] {
      ...
      new ProcessorEnumValue("brc", (Processor) BorlandResourceCompiler.getInstance()),
      ...
      new ProcessorEnumValue("xlC_r", XlcrCompiler.getInstance()),
