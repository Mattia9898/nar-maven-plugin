...
public final class IntelWin32CCompiler extends MsvcCompatibleCCompiler {
  ...
  private static final IntelWin32CCompiler instance = new IntelWin32CCompiler(null);
  ...
  private IntelWin32CCompiler(final Environment env) {
  ...
  public Processor changeEnvironment(final boolean newEnvironment, final Environment env) {
    ...
    if (newEnvironment || env != null) {
      ...
      return new IntelWin32CCompiler(env);
