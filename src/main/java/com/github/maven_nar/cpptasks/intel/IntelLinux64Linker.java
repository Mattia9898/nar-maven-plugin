...
public final class IntelLinux64Linker extends AbstractLdLinker {
  ...
  private static final IntelLinux64Linker dllLinker = new IntelLinux64Linker("lib", false,
      new IntelLinux64Linker("lib", true, null));
  ...
  private IntelLinux64Linker(final String outputPrefix, final boolean isLibtool,
      final IntelLinux64Linker libtoolLinker) {
	  
    // FREEHEP
    super("ecpc", "-V", objFiles, outputPrefix, isLibtool, libtoolLinker);
