...
public final class IntelWin64CCompiler extends MsvcCompatibleCCompiler {
  ...
  private static final IntelWin64CCompiler instance = new IntelWin64CCompiler(null);
  ...
  private IntelWin64CCompiler(final Environment env) {
  ...
  public Processor changeEnvironment(final boolean newEnvironment, final Environment env) {
    ...
    if (newEnvironment || env != null) {
      ...
      return new IntelWin64CCompiler(env);
