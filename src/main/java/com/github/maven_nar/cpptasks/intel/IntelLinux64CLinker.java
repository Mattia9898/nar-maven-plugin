...
public final class IntelLinux64CLinker extends AbstractLdLinker {
  ...
  private static final IntelLinux64CLinker dllLinker = new IntelLinux64CLinker("lib", false,
      new IntelLinux64CLinker("lib", true, null));
  ...
  private IntelLinux64CLinker(final String outputPrefix, final boolean isLibtool,
      final IntelLinux64CLinker libtoolLinker) {
	  
    super("ecc", "-V", objFiles, outputPrefix, isLibtool, libtoolLinker);
