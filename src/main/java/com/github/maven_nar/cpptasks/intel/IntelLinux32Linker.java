...
public final class IntelLinux32Linker extends AbstractLdLinker {
  ...
  private static final IntelLinux32Linker dllLinker = new IntelLinux32Linker("lib", false,
      new IntelLinux32Linker("lib", true, null));
  ...
  private IntelLinux32Linker(final String outputPrefix, final boolean isLibtool,
      final IntelLinux32Linker libtoolLinker) {
	  
    // FREEHEP
    super("icpc", "-V", objFiles, outputPrefix, isLibtool, libtoolLinker);
