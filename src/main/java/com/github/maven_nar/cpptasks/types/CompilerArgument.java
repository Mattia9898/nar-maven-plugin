...
public class CompilerArgument extends CommandLineArgument {
  ...
  /*inizio del metodo: CompilerArgument
  presenza corretta di parametri in input*/
  public CompilerArgument() {
	  
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento dello scopo del metodo: CompilerArgument*/
	  
  }
  /*fine del metodo: CompilerArgument
  esecuzione del metodo: CompilerArgument corretta, ma fuorviante*/
