...
public class ConditionalFileSet extends FileSet {
  ...
  /*inizio del metodo: ConditionalFileSet
  presenza corretta di parametri in input*/
  public ConditionalFileSet() {
	  
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento dello scopo del metodo: ConditionalFileSet*/
	  
  }
  /*fine del metodo: ConditionalFileSet
  esecuzione del metodo: ConditionalFileSet corretta, ma fuorviante*/
