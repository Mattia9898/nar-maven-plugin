...
public class LinkerArgument extends CommandLineArgument {
	  ...
	  /*inizio del metodo: LinkerArgument
	  presenza corretta di parametri in input*/
	public LinkerArgument() {
		
		  /*implementazione mancante
		  implementazione necessaria per il raggiungimento dello scopo del metodo: LinkerArgument*/
		
	}
	  /*fine del metodo: LinkerArgument
	  esecuzione del metodo: LinkerArgument corretta, ma fuorviante*/
