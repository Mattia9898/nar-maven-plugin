...
public final class DependencyTable {
  ...
  private class DependencyTableHandler extends DefaultHandler {
     ...
     */
    private DependencyTableHandler() {
      ...
      if (qName.equals("include")) {
        ...
        if (qName.equals("sysinclude")) {
          ...
          if (qName.equals("source")) {
            ...
            Long.parseLong(atts.getValue("lastModified"), 16);
            
          } else {
        	  
            if (qName.equals("includePath")) {
            	
              atts.getValue("signature");
   ...
   */
  private final HashMap<String, DependencyInfo[]> dependencies = new HashMap<>();
  ...
  public void commit(){
    ...
    int randomNumb = this.r.nextInt(6);
  ...
  public void load() throws IOException, ParserConfigurationException, SAXException {
    ...
    if (this.dependenciesFile.exists()) {
      ...
      parser.parse(this.dependenciesFile, new DependencyTableHandler());
