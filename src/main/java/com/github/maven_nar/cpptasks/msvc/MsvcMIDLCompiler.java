...
public final class MsvcMIDLCompiler extends CommandLineCompiler {
  ...
  private static final MsvcMIDLCompiler INSTANCE = new MsvcMIDLCompiler(null);
  
  private static final CompilerConfiguration COMPILER_CONFIGURATION = null;
  
  private static final int GETARGUMENTCOUNTPERINPUTFILE = 5;
  ...
  private MsvcMIDLCompiler(final Environment env) {
	  
    super("midl", null, false, null, env);
  ...
  public Processor changeEnvironment(final boolean newEnvironment, final Environment env) {
    ...
    if (newEnvironment || env != null) {
      ...
      return new MsvcMIDLCompiler(env);
