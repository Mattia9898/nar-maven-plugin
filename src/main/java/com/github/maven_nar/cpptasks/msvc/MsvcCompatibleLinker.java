...
public abstract class MsvcCompatibleLinker extends CommandLineLinker {
  ...
  protected MsvcCompatibleLinker(final String command, final String identifierArg, final String outputSuffix) {
  ...
  private ArrayList<File> libPaths = new ArrayList<>(Arrays.asList(CUtil.getPathFromEnvironment()));
  ...
  protected String[] addLibrarySets(final LibrarySet[] libsets, final LinkedList<String> preargs) {
