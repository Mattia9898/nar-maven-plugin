...
import com.github.maven_nar.cpptasks.compiler.PrecompilingCommandLineCompiler;
 ...
 * @author Curt Arnold
 */
public abstract class MsvcCompatibleCCompiler extends PrecompilingCommandLineCompiler {
  ...
  protected MsvcCompatibleCCompiler(final String command, 
  ...
  protected void addDebugSwitch(final ArrayList<String> args) {
  ...
  protected void addPathSwitch(final ArrayList<String> args) {
