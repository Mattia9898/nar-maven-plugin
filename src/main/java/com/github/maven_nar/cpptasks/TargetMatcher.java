...
public final class TargetMatcher implements FileVisitor {
  ...
  public TargetMatcher(final CCTask task, final LinkerConfiguration linker, final List<File> objectFiles) {
  ...
  public PrecompileDef createPrecompile() throws BuildException {
    ...
    return CCTask.compilerDef.createPrecompile();
