...
public abstract class Compiler {
  ...
  private static final List<File> FILES = null;
  ...
  protected final Set<String> getExcludes(final String type) {
  ...
  protected final Set<String> getIncludes(final String type) {
