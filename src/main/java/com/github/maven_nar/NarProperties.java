...
public class NarProperties {
  ...
  private static final String IOEXCEPTION_LOADING_PROPERTIES = "IOException loading properties";
  
  private static Map<MavenProject,NarProperties> instances = new HashMap<>();
   ...
   */
  public static NarProperties getInstance(final MavenProject project) {
  ...
  public static void inject(final MavenProject project, final InputStream properties) throws MojoFailureException {
    ...
    try {
      ...
      throw new MojoFailureException(IOEXCEPTION_LOADING_PROPERTIES, e);
  ...
  public Collection<String> getKnownAOLs() {
    ...
    final Pattern pattern = Pattern.compile("NarString");
