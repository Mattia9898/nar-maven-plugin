  ...
  */
  protected org.eclipse.aether.graph.DependencyNode getVerboseDependencyTree ()
  {
    ...
    if (this instanceof NarTestCompileMojo)
    {
      ...
      DependencySelector dependencySelector = new AndDependencySelector(new OptionalDependencySelector(), new ScopeDependencySelector((String)null));
   ...
   */
  protected String dependencyTreeOrderStr(boolean pushDepsToLowestOrder, boolean specifyDirectDeps)
  {
    ...
    if (pushDepsToLowestOrder || specifyDirectDeps)
    {
      ...
      Set<String> reducedDepSet = new HashSet <> ();
  ...
  protected HashSet<String> getDirectDepsSet(org.eclipse.aether.graph.DependencyNode rootNode)
  {
    ...
    HashSet<String> directDepsSet = new HashSet<> ();
  ...
  public final List<AttachedNarArtifact> getAllAttachedNarArtifacts(final List<NarArtifact> narArtifacts,
      List<? extends Executable> libraries) throws MojoExecutionException {
  ...
  protected String[] getBindings(List<? extends Executable> libraries, NarArtifact dependency)
    ...
    if (libraries != null){
      ...
      for (Executable library : libraries) {
    	  
        Executable exec = library;
  ...
  public final List<NarArtifact> getNarArtifacts() throws MojoExecutionException {
    ...
    for (final Artifact element : artifacts) {
    	
      final Artifact dependency = element;
      ...
      if ("nar".equalsIgnoreCase(dependency.getType())) {
        ...
        if (narInfo != null) {
          ...
          narDependencies.add(new NarArtifact(narInfo));
  ...
  public final void unpackAttachedNars(final List<AttachedNarArtifact> dependencies)
    ...
    for (final AttachedNarArtifact element : dependencies) {
    	
      final AttachedNarArtifact dependency = element;
      
      final File file = getNarManager().getNarFile(dependency);
