...
public abstract class AbstractCompileMojo extends AbstractDependencyMojo {
  ...
  private List/* <String> */<String> dependencyLibOrder;
  ...
  protected final boolean failOnError(final AOL aol) {
  ...
  protected final int getMaxCores(final AOL aol) {
  ...
  protected final String getOutput(final AOL aol, final String type) {
  ...
  protected final String getRuntime(final AOL aol) {
  ...
  protected final List<String> getTests() {
  ...
  protected final boolean useLibtool(final AOL aol) {
