...
public class NarGnuConfigureMojo extends AbstractGnuMojo {
  ...
  /*inizio del metodo: NarGnuConfigureMojo
  presenza corretta di parametri in input*/
  public NarGnuConfigureMojo() {
	  
	  /*implementazione mancante
	  implementazione necessaria per il raggiungimento dello scopo del metodo: NarGnuConfigureMojo*/
	  
  }
  /*fine del metodo: NarGnuConfigureMojo
  esecuzione del metodo: NarGnuConfigureMojo corretta, ma fuorviante*/
