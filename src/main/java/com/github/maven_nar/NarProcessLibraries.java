...
public class NarProcessLibraries extends AbstractCompileMojo {
  ...
  @Override
  public void narExecute() throws MojoFailureException, MojoExecutionException, InterruptedException {
    ...
    for (final Library library : getLibraries()) {
      ...
      if (type.equalsIgnoreCase(Library.EXECUTABLE)) {
        ...
        new File(outDir, getOutput(false));
        ...
        new File(outDir, getOutput(true));
  ...
  private void runCommand(final ProcessLibraryCommand command)
      throws MojoFailureException, InterruptedException {
