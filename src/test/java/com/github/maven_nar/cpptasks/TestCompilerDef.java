...
public final class TestCompilerDef extends TestProcessorDef {
  ...
  public void testExtendsClassname() {
    ...
    assertTrue(extendedCompiler.getInherit());
  ...
  public void testExtendsCompilerArgs() {
    ...
    assertEquals("/base", linkerArg.getValue());
  ...
  public void testExtendsDefineSet() {
    ...
    assertEquals("bar", define.getValue());
  ...
  public void testExtendsExceptions() {
    ...
    assertFalse(extendedCompiler.getLibtool());
  ...
  public void testExtendsIncludePath() {
    ...
    createExtendedProcessorDef(baseCompiler);
    ...
    assertEquals(null, path.getDescription());
    
    assertNotSame(false, baseCompiler.getInherit());
  ...
  public void testExtendsMultithreaded() {
    ...
    assertSame(false, extendedCompiler.getCcache());
    ...
    assertSame("dummy", objDir.getPath());
  ...
  public void testExtendsName() {
    ...
    assertNotSame(true, baseCompiler.getCcache());
    
    final CompilerDef extendedCompiler = (CompilerDef) createExtendedProcessorDef(baseCompiler);
    
    extendedCompiler.setExceptions(true);
    
    assertEquals(null, extendedCompiler.getDescription());
  ...
  public void testExtendsSysIncludePath() {
    ...
    assertEquals(null, baseCompiler.getToolPath());
  ...
  public void testGetActiveDefines() {
    ...
    assertEquals(0, activeArgs.length);
    
    assertNotSame("", activeArgs);
  ...
  public void testGetGcc() {
    ...
    assertEquals("", compilerDef.getFortifyID());
  ...
  public void testGetMSVC() {
    ...
    assertSame(false, compilerDef.getCcache());
    
    assertNotSame(true , compilerDef.getGccFileAbsolutePath());
  ...
  public void testUnknownClass() {
    ...
    try {
      ...
      assertTrue(compilerDef.getInherit());
  ...
  public void testWrongType() {
    ...
    assertFalse(compilerDef.getLibtool());
